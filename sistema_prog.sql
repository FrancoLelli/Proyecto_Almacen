...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2022 a las 23:34:04
...
CREATE TABLE `cliente` (
  ...
  `Cli_nombre` varchar(25) DEFAULT NULL,
  `Cli_apellido` varchar(25) DEFAULT NULL,
  `Cli_DNI` int(11) DEFAULT NULL,
  `Cli_id_loc` int(11) DEFAULT NULL,
  `estadoReal` int(11) DEFAULT NULL
...
INSERT INTO `cliente` (`Cli_id`, `Cli_nombre`, `Cli_apellido`, `Cli_DNI`, `Cli_id_loc`, `estadoReal`) VALUES
(1, 'Dante', 'Roselli', 427548973, 2104, 1),
(2, 'Franco', 'Lelli', 42272309, 1961, 1),
(3, 'Roberto', 'Luz', 32345654, 2104, 1);
...
CREATE TABLE `estado` (
  ...
  `estadoValor` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `estado` (`estado`, `nombre`, `estadoValor`) VALUES
(b'0', 'Inactivo', 0),
(b'1', 'Activo', 1);
...
--
-- Estructura de tabla para la tabla `loc`
--

CREATE TABLE `loc` (
  `Loc_id` int(11) NOT NULL,
  `Loc_id_prov` int(11) DEFAULT NULL,
  `Loc_nombre` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `loc`
--

INSERT INTO `loc` (`Loc_id`, `Loc_id_prov`, `Loc_nombre`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
CREATE TABLE `prod` (
  ...
  `Prod_id_prov` int(11) DEFAULT NULL,
  `estadoReal` int(11) DEFAULT NULL,
  `CodigoProd` varchar(25) DEFAULT NULL,
...
INSERT INTO `prod` (`Prod_id`, `Prod_nombre`, `Prod_stock`, `Prod_id_prov`, `estadoReal`, `CodigoProd`, `precio`) VALUES
(1, 'CocaCola', 9, 7, 1, 'COC12', 200),
(2, 'Pepsi', 9, 8, 1, 'PEP1', 170),
(3, 'Manaos', 12, 7, 1, 'MAN14', 130),
(4, 'Sprite', 35, 7, 1, 'SPR3', 160),
(5, 'Lays', 9, 8, 1, 'LAY2', 120),
(6, 'Pringles', 12, 7, 1, 'PRI7', 40),
(7, 'Mouse Gamer', 4, 9, 1, 'MOU8', 200),
(9, 'Teclado Gamer', 5, 9, 1, 'TEC', 300),
(11, 'Papas Fritas', 10, 10, 1, 'PAP12', 200);
...
CREATE TABLE `prod_venta` (
  `ProdVent_id` int(11) NOT NULL,
  `ProdVent_prod` int(11) DEFAULT NULL,
  `ProdVent_venta` int(11) DEFAULT NULL,
  `ProdVent_cantidad` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `prod_venta1`
--

CREATE TABLE `prod_venta1` (
  `ProdVent_id` int(11) NOT NULL,
  `ProdVent_venta` int(11) DEFAULT NULL,
  `ProdVent_prod` int(11) DEFAULT NULL,
  `ProdVent_cantidad` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `prod_venta1`
--

INSERT INTO `prod_venta1` (`ProdVent_id`, `ProdVent_venta`, `ProdVent_prod`, `ProdVent_cantidad`, `precioVenta`) VALUES
(1, 1, 1, 4, 1340),
(20, 7, 9, 3, 870),
(52, 8, 4, 2, 320),
(53, 8, 9, 3, 900),
...
INSERT INTO `prov` (`Prov_id`, `Prov_nombre`) VALUES
(1, 'Buenos Aires'),
(2, 'Buenos Aires-GBA'),
(3, 'Capital Federal'),
(4, 'Catamarca'),
...
--
-- Estructura de tabla para la tabla `proveedor1`
--

CREATE TABLE `proveedor1` (
  `Prod_id` int(11) NOT NULL,
  `Prov_id_loc` int(11) DEFAULT NULL,
  `Prov_nombre` varchar(25) DEFAULT NULL,
  `Prov_apellido` varchar(25) DEFAULT NULL,
  `Prov_DNI` int(11) DEFAULT NULL,
  `estadoReal` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `proveedor1`
--

INSERT INTO `proveedor1` (`Prod_id`, `Prov_id_loc`, `Prov_nombre`, `Prov_apellido`, `Prov_DNI`, `estadoReal`) VALUES
(7, 1961, 'Coca Cola Company', 'CocaCola ', 2147483647, 1),
(8, 1961, 'Pepsico Argentina', 'Pepsico', 2147483647, 1),
(9, 543, 'Logitech SA', 'Logitech Company', 2147483647, 1),
(10, 1546, 'Arcos Dorados Argentina S', 'Mc Donals', 2147483647, 1);
...
INSERT INTO `usuario` (`Usu_id`, `Usu_nombre`, `Usu_email`, `Usu_contra`) VALUES
(1, 'Franco', 'franco@gmail.com', '1234'),
(2, 'Tomas', 'tomas@gmail.com', '1234');
...
CREATE TABLE `venta` (
  ...
  `Vent_id_cliente` int(11) DEFAULT NULL,
  `Vent_id_prodvent` int(11) DEFAULT NULL,
  `Vent_precio_tot` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `venta1` (
  `Vent_id` int(11) NOT NULL,
  `Vent_id_cliente` int(11) DEFAULT NULL,
  `Vent_precio_tot` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `venta1` (`Vent_id`, `Vent_id_cliente`, `Vent_precio_tot`) VALUES
(1, 1, 1340),
(6, 1, 390),
(7, 2, 1533),
(8, 3, 2420),
...
--
-- Indices de la tabla `loc`
--
ALTER TABLE `loc`
  ADD PRIMARY KEY (`Loc_id`),
  ADD KEY `Loc_id_prov` (`Loc_id_prov`);
...
ALTER TABLE `prod`
  ...
  ADD KEY `Prod_id_prov` (`Prod_id_prov`);

--
-- Indices de la tabla `prod_venta`
--
ALTER TABLE `prod_venta`
  ADD PRIMARY KEY (`ProdVent_id`),
  ADD KEY `ProdVent_prod` (`ProdVent_prod`),
  ADD KEY `ProdVent_venta` (`ProdVent_venta`);

--
-- Indices de la tabla `prod_venta1`
--
ALTER TABLE `prod_venta1`
  ADD PRIMARY KEY (`ProdVent_id`);
...
--
-- Indices de la tabla `proveedor1`
--
ALTER TABLE `proveedor1`
  ADD PRIMARY KEY (`Prod_id`);
...
ALTER TABLE `venta`
  ...
  ADD KEY `Vent_id_cliente` (`Vent_id_cliente`),
  ADD KEY `Vent_id_prodvent` (`Vent_id_prodvent`);
...
--
-- AUTO_INCREMENT de la tabla `loc`
--
ALTER TABLE `loc`
  MODIFY `Loc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2383;
...
--
-- AUTO_INCREMENT de la tabla `prod_venta`
--
ALTER TABLE `prod_venta`
  MODIFY `ProdVent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `prod_venta1`
--
ALTER TABLE `prod_venta1`
  MODIFY `ProdVent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT de la tabla `prov`
--
ALTER TABLE `prov`
  MODIFY `Prov_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `proveedor1`
--
ALTER TABLE `proveedor1`
...
--
ALTER TABLE `venta1`
  MODIFY `Vent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`Cli_id_loc`) REFERENCES `loc` (`Loc_id`);

--
-- Filtros para la tabla `loc`
--
ALTER TABLE `loc`
  ADD CONSTRAINT `loc_ibfk_1` FOREIGN KEY (`Loc_id_prov`) REFERENCES `prov` (`Prov_id`);

--
-- Filtros para la tabla `prod`
--
ALTER TABLE `prod`
  ADD CONSTRAINT `prod_ibfk_1` FOREIGN KEY (`Prod_id_prov`) REFERENCES `prov` (`Prov_id`);

--
-- Filtros para la tabla `prod_venta`
--
ALTER TABLE `prod_venta`
  ADD CONSTRAINT `prod_venta_ibfk_1` FOREIGN KEY (`ProdVent_prod`) REFERENCES `prod` (`Prod_id`),
  ADD CONSTRAINT `prod_venta_ibfk_2` FOREIGN KEY (`ProdVent_venta`) REFERENCES `venta` (`Vent_id`);

--
-- Filtros para la tabla `venta`
--
ALTER TABLE `venta`
  ADD CONSTRAINT `venta_ibfk_1` FOREIGN KEY (`Vent_id_cliente`) REFERENCES `cliente` (`Cli_id`),
  ADD CONSTRAINT `venta_ibfk_2` FOREIGN KEY (`Vent_id_prodvent`) REFERENCES `prod_venta` (`ProdVent_id`);
COMMIT;
