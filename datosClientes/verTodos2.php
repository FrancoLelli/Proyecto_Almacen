...
<body>
    ...
    <main>
        <div>
            <h1 class="tituloPagina">REGISTROS CLIENTES</h1>
        </div>
        <section class="panelProv">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                        $arrayConsulta = $db->query("SELECT (cliente.Cli_id) as 'id' ,(cliente.Cli_nombre) as 'Nombre', (cliente.Cli_apellido) as 'Apellido', (loc.Loc_nombre) as 'Ciudad', estadoReal FROM cliente,loc WHERE loc.Loc_id = cliente.Cli_id_loc");
                        ...
                        while($consulta != null){
                            ...
                            echo "<td>
                            <a href='./editar2.php?id=".$consulta['id']."'><button type='submit' class='btn btn-secondary' name='editarReg'>Editar</button></a> 
                            </td></tr>";
            ...
            <a href="../clientes.php"><button class='btn btn-secondary'>Volver</button></a>
